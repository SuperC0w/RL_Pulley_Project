...
class ParamWrapper:
    ...
    def get_I4(self, theta):
        return self._I4_scale * self._base.get_I4(theta)

    @property
    def I5(self):
        return self._I5_scale * self._base.I5

    @property
    def I1(self):
        return self._I1_scale * self._base.I1

    @property
    def I2(self):
        return self._I2_scale * self._base.I2

    @property
    def I3(self):
        return self._I3_scale * self._base.I3
...
def main():
    ...
    bounds = (
        np.array([
            0.0, 1e-8, 0.2, 1.0,   # spring 1
            0.0, 1e-8, 0.2, 1.0,   # spring 2
            0.0, 1e-8, 0.2, 1.0,   # spring 3
            0.2, 0.2,              # I4/I5 scale
    ...
    progress = None
    total = args.max_nfev if args.method == "least_squares" else args.random_iters
