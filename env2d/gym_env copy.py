...
class PulleyEnvGym(gym.Env):
    ...
    def __init__(self, dt=0.001, max_steps=10000, render_mode=None, seed=None, action_repeat=10, max_action_diff1=0.020, max_action_diff2=0.020):
        super().__init__()
        self.dt = float(dt)
        ...
        self.u_coact_min = (0 + max_action_diff1/2 + max_action_diff1/4)*2
